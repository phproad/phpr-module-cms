...
$table = Db_Structure::table('cms_pages');
	...
	$table->column('sitemap_visible', db_bool)->defaults(true);
	$table->column('published', db_bool)->defaults(true);
	...
	$table->column('security_id', db_varchar, 15)->defaults('everyone');
...
$table = Db_Structure::table('cms_content');
	...
	$table->column('type', db_varchar, 10)->defaults('html');
	$table->column('content', 'mediumtext');
...
$table = Db_Structure::table('cms_themes');
	...
	$table->column('is_default', db_bool);
	$table->column('enabled', db_bool)->defaults(true);
